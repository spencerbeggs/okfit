...
* [Effect v4 pinned to catalog:effect](effect-v4-pinned-version.md) - Every okfit package uses Effect v4 at the version pinned in catalog:effect; node\_modules wins over the vendored source on disagreement.
