...
* [LSP](lsp.md) - The okfit-lsp language server, publishing engine diagnostics for a discovered bundle over stdio to Claude Code and any LSP client.
...
* [VS Code Extension](vscode-extension.md) - The okfit VS Code extension -- a language client for @okfit/lsp plus a concept explorer, Language Status item and commands, published to the Marketplace and Open VSX.
